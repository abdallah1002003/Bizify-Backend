"""Initial migration with multi-role support

Revision ID: 916a5561bb27
Revises: 
Create Date: 2026-03-13 14:06:27.790159
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'USER', 'ENTREPRENEUR', 'MENTOR', 'SUPPLIER', 'MANUFACTURER', name='userrole'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['idea_id'], ['ideas.id'], name='fk_business_idea_id', use_alter=True),
    ...
    sa.ForeignKeyConstraint(['business_id'], ['businesses.id'], name='fk_idea_business_id', use_alter=True),
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'CANCELED', name='subscriptionstatus'), nullable=True),
    ...
    sa.Column('business_id', sa.UUID(), nullable=True),
    sa.Column('idea_id', sa.UUID(), nullable=True),
    sa.Column('session_type', sa.Enum('IDEA_CHAT', 'BUSINESS_CHAT', 'STAGE_CHAT', 'GENERAL', name='sessiontype'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['comparison_id'], ['idea_comparisons.id'], ),
    sa.ForeignKeyConstraint(['idea_id'], ['ideas.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('LOCKED', 'ACTIVE', 'COMPLETED', name='stagestatus'), nullable=True),
    sa.Column('output_json', sa.JSON(), nullable=True),
    sa.Column('completed_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['roadmap_id'], ['business_roadmaps.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('SUCCESS', 'FAILED', 'WARNING', name='runstatus'), nullable=True),
