...
if TYPE_CHECKING:
    ...
    from app.models.partners.partner import PartnerRequest
    from app.models.ai.agent import Embedding, AgentRun
    from app.models.ideation.idea_access import IdeaAccess
