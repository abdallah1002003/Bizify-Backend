...
class UserService(BaseService):
    ...
    async def get_users(self, skip: int = 0, limit: int = 100) -> List[User]:
        ...
        return await self.user_repo.get_all_with_profiles(skip=skip, limit=limit)
    ...
    async def create_user(self, obj_in: Union[Dict[str, Any], Any]) -> User:
        ...
        try:
            ...
            existing_profile = await self.profile_repo.get_by_user_id(db_obj.id)
            if not existing_profile:
                await self.profile_repo.create({"user_id": db_obj.id, "bio": "", "preferences_json": {}}, auto_commit=False)
    ...
    async def has_admin_user(self) -> bool:
        """Returns whether at least one administrator exists in the system."""
    ...
    async def create_user_profile(self, obj_in: Any) -> UserProfile:
        ...
        return await self.profile_repo.create(obj_in)
    ...
    async def update_user_profile(
        ...
        updated = await self.profile_repo.update(db_obj, obj_in)
    ...
    async def delete_user_profile(self, id: UUID) -> Optional[UserProfile]:
        ...
        return await self.profile_repo.delete(id)
    ...
    async def get_admin_action_log(self, id: UUID) -> Optional[AdminActionLog]:
        ...
        return await self.admin_log_repo.get(id)
    ...
    async def create_admin_action_log(self, obj_in: Any) -> AdminActionLog:
        ...
        return await self.admin_log_repo.create(obj_in)
